...
public class TxHandler {
    ...
    public boolean isValidTx(Transaction tx) {
        ...
        if (sumInputs < sumOutputs) return !VALID;
//        else if (sumInputs==sumOutputs) System.out.println("Found no fee transaction");
//        else System.out.println("Found high fee transaction: " + (sumInputs - sumOutputs));
