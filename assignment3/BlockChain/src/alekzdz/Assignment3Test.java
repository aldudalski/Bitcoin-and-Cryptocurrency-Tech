...
public class Assignment3Test {
	...
	public boolean test25() {
		...
		boolean bit1 = createdBlock != null;
		boolean bit2 = createdBlock.getPrevBlockHash().equals(firstBlock.getHash());

		ByteArrayWrapper prevhash = new ByteArrayWrapper(createdBlock.getPrevBlockHash());
		ByteArrayWrapper firsthash = new ByteArrayWrapper(firstBlock.getHash());

		boolean bit2a = prevhash.equals(firsthash);

		boolean bit3 = createdBlock.getTransactions().size() == 0;

//		boolean passes2 = createdBlock != null && createdBlock.getPrevBlockHash().equals(firstBlock.getHash())
//				&& createdBlock.getTransactions().size() == 0;

		boolean passes2 = bit1 && bit2a && bit3;
	...
	public static void main(String[] args) {
		Assignment3Test runner = new Assignment3Test();
		int numSuccess = 0;
		int numTotal = 27;
		...
		System.out.println("=============================================");
		System.out.println(Integer.toString(numSuccess) + "/" + Integer.toString(numTotal) + " tests passed ("+String.format("%1$,.2f",new Double(numSuccess)/new Double(numTotal)*100.0)+"%)");
